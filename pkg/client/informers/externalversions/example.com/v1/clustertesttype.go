...
import (
	...
	v1 "github.com/sakiib/crd/pkg/client/listers/example.com/v1"
...
func (f *clusterTestTypeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplecomv1.ClusterTestType{}, f.defaultInformer)
}
